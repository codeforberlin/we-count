...
src/we_count/backend/telraam_backup.py -j csv/bzm_telraam_segments.geojson -p parquet/bzm_telraam_traffic_data.parquet -v --csv csv/bzm_telraam --csv-segments csv/segments/bzm_telraam --csv-start-year 2021
